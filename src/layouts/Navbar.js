...
class NavbarComponent extends React.Component {
    ...
    render() {
        return (
            <Navbar bg="light" expand="lg" ref={this.navbar} className={"navbar navbar-marketing navbar-expand-lg bg-transparent navbar-dark fixed-top " + this.state.classNameColorNav + this.state.classNameScroll + this.state.classNameResized}>
                <div className="container">
                    <Navbar.Brand href="/" className="navbar-brand text-white">Ira Bubela Dev</Navbar.Brand>
                    ...
                    <Navbar.Collapse id="basic-navbar-nav" className="collapse navbar-collapse">
                        ...
                        <a className="btn font-weight-500 ml-lg-4 btn-teal" href="assets/img/BubelaIrinaCV.pdf" download>
                            Resume
